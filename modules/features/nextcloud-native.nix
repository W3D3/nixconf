      ...
      nextcloud-native = pkgs.callPackage (
        ...
        stdenv.mkDerivation (finalAttrs: {
          ...
          installPhase = ''
            ...
            # Separate wrapper (not in-place) so the jpackage launcher keeps its
            # name and still finds NextcloudNative.cfg. OAuth login opens the
            # browser via xdg-open.
            makeWrapper $out/opt/nextcloudnative/bin/NextcloudNative $out/bin/nextcloudnative \
